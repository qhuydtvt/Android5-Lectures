...
public class MainActivity extends AppCompatActivity {
    ...
    public void OnServiceEvent(ServiceEvent serviceEvent) {
        Intent intent = new Intent(this, serviceEvent.getaClass());
        startService(intent);
    }

    @Subscribe
    public void OnShowDialogEvent(AlertDialogEvent alertDialogEvent) {
        new AlertDialog
                .Builder(this)
                .setTitle(alertDialogEvent.getTitle())
                .setMessage(alertDialogEvent.getMessage())
                .setCancelable(alertDialogEvent.isCancelable())
                .setPositiveButton(alertDialogEvent.getPositiveButtonTitle(), null)
                .create().show();
    }
